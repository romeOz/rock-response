 ...
 * ```php
 * 'response' => [
 *     'format' => rock\response\Response::FORMAT_JSON,
 *     'charset' => 'UTF-8',
 *     // ...
 * ]
 * ```
...
class Response implements EventsInterface
{
    ...
    {
        return [
            self::FORMAT_HTML => HtmlResponseFormatter::className(),
            self::FORMAT_XML => XmlResponseFormatter::className(),
            self::FORMAT_RSS1 => [
                'class' => RssResponseFormatter::className(),
                'type' => RssResponseFormatter::RSS1
            ],
            self::FORMAT_RSS2 => [
                'class' => RssResponseFormatter::className(),
                'type' => RssResponseFormatter::RSS2
            ],
            self::FORMAT_ATOM => [
                'class' => RssResponseFormatter::className(),
                'type' => RssResponseFormatter::ATOM
            ],
            self::FORMAT_SITEMAP => [
                'class' => SitemapResponseFormatter::className(),
            ],
